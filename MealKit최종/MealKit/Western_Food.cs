...
namespace MealKit
{
    public partial class Western_Food : Form
    {
        public Western_Food()
        {
            InitializeComponent();
            // Form Load 이벤트에 이벤트 핸들러 추가
            this.Load += 양식_Load;
        ...
        private void 양식_Load(object sender, EventArgs e)
        {
        ...
        private void AddUCItemsToPanel()
        {
            ...
            {
                if (product.item_kind.ToLower() == "양식")
                {
                    ...
                    if (image != null)
                    {
                        ...
                        // 클릭 이벤트 핸들러 등록
                        ucItem.ItemClicked += (s, e) => UC_Item_Click_양식(ucItem);   
        ...
        private void UC_Item_Click_양식(UC_Item ucItem)   
        {
            try
            {
                // 중복된 상품이 이미 있는지 확인
        ...
        private void button8_Return_Main_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void button10_Purchase_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void button9_Contian_Click(object sender, EventArgs e)
        {
            this.Hide();
